...
export function EventModal() {
  ...
  return (
    <div className="pointer-events-auto absolute inset-0 flex items-center justify-center bg-black/60 backdrop-blur-[2px] z-50">
      <div className="hud-panel-enter w-96 rounded-2xl border border-white/10 bg-gradient-to-b from-[#1c1f29]/98 to-[#111319]/98 backdrop-blur-xl shadow-[0_30px_80px_-20px_rgba(0,0,0,0.85)] ring-1 ring-white/[0.06] overflow-hidden">
